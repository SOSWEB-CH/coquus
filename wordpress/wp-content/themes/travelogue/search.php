...
<?php get_sidebar(); ?>
	...
	<h2 class="pagetitle"><?php _e('Search Results:', 'travelogue'); ?></h2>
			...
			<div class="post">
				<div class="post_cal">
					...
					<div class="daynum"><?php echo $postdate[1]; ?></div>
						...
						<?php /* You can make the full "200x" date go here by uncommenting 
				...
				<div class="post_head">
					...
					<p class="postmetadata"><?php printf(__("Part of %s's adventure in ", 'travelogue'), get_the_author()); ?> <?php the_category(', '); ?> <?php edit_post_link(__('Edit', 'travelogue'),'<strong> | (',')</strong>'); ?></p> 
				</div>
